<p align="center">
    <img width="640px" src="https://wazuh.com/brand-assets/Cyb3rhq-Logo.svg"/>
</p>

[![Chat](https://img.shields.io/badge/chat-on%20forums-blue)](https://groups.google.com/forum/#!forum/cyb3rhq)
...
[![Build packages](https://github.com/cyb3rhq/cyb3rhq-indexer/actions/workflows/build.yml/badge.svg)](https://github.com/cyb3rhq/cyb3rhq-indexer/actions/workflows/build.yml)
...
The Cyb3rhq indexer is a highly scalable, full-text search and analytics engine. This Cyb3rhq central component indexes and stores alerts generated by the Cyb3rhq server and provides near real-time data search and analytics capabilities.

Cyb3rhq indexer is a open source fork of [OpenSearch](https://github.com/opensearch-project/opensearch).
...
* [Contributing to Cyb3rhq indexer](CONTRIBUTING.md)
...
Check Cyb3rhq's [trademark and Brand policy](https://wazuh.com/trademark-and-brand-policy/).
