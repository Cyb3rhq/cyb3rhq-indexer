...
## Scope
This policy applies to all open source projects developed, maintained, or hosted by Cyb3rhq. In this case, as this project is a fork, we may forward the reported vulnerability to the upstream.
