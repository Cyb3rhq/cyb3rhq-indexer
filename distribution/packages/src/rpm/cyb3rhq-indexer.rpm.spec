...
%description
Cyb3rhq indexer is a near real-time full-text search and analytics engine that
gathers security-related data into one platform. This Cyb3rhq central component
indexes and stores alerts generated by the Cyb3rhq server. Cyb3rhq indexer can be
...
%define observability_plugin %( if [ -f %{_topdir}/etc/cyb3rhq-indexer/opensearch-observability/observability.yml ]; then echo "1" ; else echo "0"; fi )
%define reportsscheduler_plugin %( if [ -f %{_topdir}/etc/cyb3rhq-indexer/opensearch-reports-scheduler/reports-scheduler.yml ]; then echo "1" ; else echo "0"; fi )
