...
# Events generator tool for Cyb3rhq's indices.
...
#  -i: index name prefix or module (e.g: cyb3rhq-alerts, cyb3rhq-states-vulnerabilities)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Events generator tool for Cyb3rhq's indices. Indexes a random element from <index>/alerts.json",
    )
    parser.add_argument(
        '-i', '--index',
        default="cyb3rhq-alerts-4.x-sample",
    ...
    parser.add_argument(
        ...
        help="Cyb3rhq module to read the alerts from (e.g: cyb3rhq-alerts, cyb3rhq-states-vulnerabilities). Must match a subfolder's name."
    )
